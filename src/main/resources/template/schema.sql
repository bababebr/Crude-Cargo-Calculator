CREATE TABLE IF NOT EXISTS CalibrationTable
(
...
INSERT INTO CalibrationTable(ULLAGE, TANK, Cub1F, Cub, Cub1A, Cub2A, Cub3A, Cub4A) SELECT * FROM CSVREAD('src/main/resources/static/1P.csv');
INSERT INTO CalibrationTable(ULLAGE, TANK, Cub1F, Cub, Cub1A, Cub2A, Cub3A, Cub4A) SELECT * FROM CSVREAD('src/main/resources/static/1S.csv');
INSERT INTO CalibrationTable(ULLAGE, TANK, Cub1F, Cub, Cub1A, Cub2A, Cub3A, Cub4A) SELECT * FROM CSVREAD('src/main/resources/static/2P.csv');
INSERT INTO CalibrationTable(ULLAGE, TANK, Cub1F, Cub, Cub1A, Cub2A, Cub3A, Cub4A) SELECT * FROM CSVREAD('src/main/resources/static/2S.csv');
INSERT INTO CalibrationTable(ULLAGE, TANK, Cub1F, Cub, Cub1A, Cub2A, Cub3A, Cub4A) SELECT * FROM CSVREAD('src/main/resources/static/3P.csv');
